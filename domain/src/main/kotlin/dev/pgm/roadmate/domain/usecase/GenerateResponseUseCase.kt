 ...
 *
 * Three local shortcuts are checked before ever touching Gemini, in this order:
 ...
 *  3. Joke requests — answered from JokeProvider's local bank.
 * All three work identically whether or not this device has on-device AI,
